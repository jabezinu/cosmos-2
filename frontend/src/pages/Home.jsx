...
// import React, { useState, useEffect } from 'react';
// import { Star, Clock, MapPin, Phone, Mail, Send, Sparkles, Coffee, Utensils, Heart } from 'lucide-react';
// import './styles.css'; // Import custom CSS for the animation
...
//   return (
//     <main className="min-h-screen relative bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
...
//             <p className="text-xl md:text-2xl text-slate-300 font-light max-w-3xl mx-auto leading-relaxed">
//               Where culinary artistry meets cosmic wonder. Experience flavors that transport you beyond the ordinary, 
//               in an atmosphere that is truly <em className="text-cyan-300">out of this world</em>.
//             </p>
            
//             <div className="flex flex-col sm:flex-row gap-6 justify-center items-center pt-8">
//               <button className="group relative px-10 py-4 bg-gradient-to-r from-cyan-500 via-purple-500 to-pink-500 text-white font-bold text-lg rounded-full overflow-hidden transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/25">
//                 <span className="relative z-10 flex items-center space-x-2">
//                   <Utensils className="w-5 h-5" />
//                   <span>Reserve Your Table</span>
//                 </span>
...
//               <div className="space-y-6 text-lg text-slate-300 leading-relaxed">
//                 <p>
//                   Born from a dream to create more than just a dining destination, <strong className="text-cyan-300">Cosmos</strong> represents 
//                   our passion for culinary excellence merged with an otherworldly atmosphere that sparks imagination and wonder.
//                 </p>
//                 <p>
//                   Founded in 2020 by award-winning chef Maria Stellar and architect David Nebula, our restaurant combines 
//                   innovative gastronomy with immersive design, creating an experience that engages all your senses.
//                 </p>
//                 <p>
//                   Every ingredient is carefully sourced from local artisans and sustainable farms, while our kitchen team 
//                   transforms these elements into dishes that are both visually stunning and explosively flavorful.
//                 </p>
//               </div>
...
//                     <div>
//                       <div className="font-semibold text-white">Address</div>
//                       <div className="text-slate-400">123 Stellar Avenue<br />Cosmic District, Galaxy City 12345</div>
//                     </div>
//                   </div>
...
//                     <div>
//                       <div className="font-semibold text-white">Phone</div>
//                       <div className="text-slate-400">(555) 123-COSMOS</div>
//                     </div>
//                   </div>
